...
chcp 65001 >nul
echo ================================================
echo    Chatwoot Flutter Quick Deployment
echo ================================================
echo.
...
REM Step 1: Check build files
if not exist "deploy_package.tar.gz" (
    echo ❌ deploy_package.tar.gz not found
    echo Please run first: tar -czf deploy_package.tar.gz -C build web
    pause
    exit /b 1
)
...
echo [2/4] Deploying application files...
...
echo ================================================
echo.
echo Access URL: http://43.157.0.135
echo.
pause
